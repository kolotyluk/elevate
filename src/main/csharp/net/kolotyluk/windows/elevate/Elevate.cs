		...
		public static int Main(string[] commandArguments)
		{
			...
			else
			{
				...
				try
	     		{
					...
					process.StartInfo = new System.Diagnostics.ProcessStartInfo(commandArguments[1], processArguments);
				...
				catch (SocketException socketException)
				{
	      		...
	      		{
					emit("Exception: " + exception.Message, streamWriter, EventLogEntryType.Error);
	      		}
				finally
				{
